...
- `RoteadorInteligente` considera adequação, hardware, capacidades declaradas, health opcional, histórico operacional real medido e, quando há amostra suficiente, custo real histórico.
