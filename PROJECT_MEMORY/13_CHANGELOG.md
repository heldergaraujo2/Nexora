...
## v0.10.0 — Fase 10( Evolution Engine)— 2026-09-11

- [x] feat(evolucao): Aprendizado, RegistroAprendizados(JSONL append-only, listar determinístico, resumir com taxa media por variante)e RecomendadorEvolucao(evoluir consome resultados de experimentos、 recomendar melhor abordagem determinístico.
- [x] feat(cli: evoluir): subcomando nexora evoluir aprender --tarefa --arquivo e nexora evoluir recomendar --tarefa --arquivo; demais CLIs mantidos.

- [x] test(evolucao): 5 novos testes( 89 →94.)
...
- [x] feat(cli: experiencia): subcomando nexora experiencia resumir|listar --arquivo; demais CLIs mantidos.불
...
- [x] feat(cli: agente pesquisar): subcomando nexora agente pesquisar com ferramenta fake buscar para demo sem rede.불
...
- [x] feat(cli: agente codar): subcomando nexora agente codar; executar mantido.불
...
- v0.1.0 — Fase 1(Fundação— commit e73a266.불
